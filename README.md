...
```sh
pip install git+https://github.com/vorpax/python-client-generated.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/python-client-generated.git`)
