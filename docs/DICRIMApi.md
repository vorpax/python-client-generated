# swagger_client.DICRIMApi

All URIs are relative to *https://georisques.gouv.fr/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**recherche_risques6**](DICRIMApi.md#recherche_risques6) | **GET** /v1/gaspar/dicrim | Lister les Documents d&#x27;Information Communale sur les Risques Majeurs (DICRIM) sur le territoire concerné

# **recherche_risques6**
> PaginatedResponseDicrim recherche_risques6(rayon=rayon, latlon=latlon, code_insee=code_insee, page=page, page_size=page_size)

Lister les Documents d'Information Communale sur les Risques Majeurs (DICRIM) sur le territoire concerné
...
api_instance = swagger_client.DICRIMApi()
...
try:
    # Lister les Documents d'Information Communale sur les Risques Majeurs (DICRIM) sur le territoire concerné
    api_response = api_instance.recherche_risques6(rayon=rayon, latlon=latlon, code_insee=code_insee, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DICRIMApi->recherche_risques6: %s\n" % e)
```
...
[**PaginatedResponseDicrim**](PaginatedResponseDicrim.md)
