# swagger_client.ZonageSismiqueApi

All URIs are relative to *https://georisques.gouv.fr/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**recherche_radon**](ZonageSismiqueApi.md#recherche_radon) | **GET** /v1/zonage_sismique | Lister les zonages sismiques

# **recherche_radon**
> PaginatedResponseZonageSismique recherche_radon(rayon=rayon, latlon=latlon, code_insee=code_insee, page=page, page_size=page_size)

Lister les zonages sismiques
...
api_instance = swagger_client.ZonageSismiqueApi()
...
try:
    # Lister les zonages sismiques
    api_response = api_instance.recherche_radon(rayon=rayon, latlon=latlon, code_insee=code_insee, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ZonageSismiqueApi->recherche_radon: %s\n" % e)
```
...
[**PaginatedResponseZonageSismique**](PaginatedResponseZonageSismique.md)
